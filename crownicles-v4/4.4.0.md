...
<figure><img src="../.gitbook/assets/image (3) (2).png" alt=""><figcaption><p>Le premier voyage est gratuit !</p></figcaption></figure>

`classement guilde` - Affiche le classement des guildes

<figure><img src="../.gitbook/assets/image (4) (3).png" alt=""><figcaption><p>Un nouveau classement à dominer !</p></figcaption></figure>

### Autres ajouts :

* Ajout d'une île mystérieuse permettant de combattre des monstres.&#x20;

<figure><img src="../.gitbook/assets/image (2) (1) (2) (1).png" alt=""><figcaption><p>C'est parti let's go, allons-y les amis !</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (5) (2).png" alt=""><figcaption><p>Trop bien ! Pleins de conseils !</p></figcaption></figure>

* Amélioration de la commande `carte` pour supporter l'île mystérieuse&#x20;

<figure><img src="../.gitbook/assets/image (195).png" alt=""><figcaption><p>La croix rouge c'est un trésor : Vous <span data-gb-custom-inline data-tag="emoji" data-code="2764">❤️</span></p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (1) (1) (1) (2) (1) (1) (1) (1) (1).png" alt=""><figcaption><p>Un exemple de mini évènement où vous tapez un animal sauvage méchant.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (2) (1) (2).png" alt=""><figcaption><p>spooky scary skeletons</p></figcaption></figure>
